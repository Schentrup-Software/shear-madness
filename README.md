...
- 💬 **Google Chat Notifications**: Optionally DM players through the whole tournament — anthem call, on-deck warning, their turn, their result, and the champions announcement — see [docs/google-chat-setup.md](docs/google-chat-setup.md)
